...
public struct SkechworksFile {
    ...
    public static func write(document: Document,
        ...
        let doc: [String: Any] = [
            ...
            "generator": "Skechworks liberator",
    ...
    public enum ReadError: Error, CustomStringConvertible {
        ...
        public var description: String {
            ...
            case .notSkechworks:
                return "not a Skechworks document — the archive belongs to another app"
            }
        }
    }
    ...
    public static func normalisedName(_ name: String) -> String {
        ...
        // saving an Accomplice-era file is how it becomes a Skechworks one.
    ...
    public static func read(_ data: Data) throws -> (document: Document, images: [String: Data]) {
        ...
        if dj["_class"] != nil { throw ReadError.notSkechworks }
    ...
    private static func readme(_ d: Document, _ cover: Int) -> String {
        ...
        You do not need Skechworks to get your work back out of this file. That is
