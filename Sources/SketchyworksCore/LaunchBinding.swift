...
// Makes a .sw.png open in Sketchyworks on double-click without stealing every PNG
// on the machine.
//
...
public enum LaunchBinding {
    ...
    public static let defaultBundleID = "com.sketchyworks.Sketchyworks"
    static let attribute = "com.apple.LaunchServices.OpenWith"

    /// Binds this one file to Sketchyworks. Naming only the bundle identifier — not a
