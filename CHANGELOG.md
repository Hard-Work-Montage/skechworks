...
## 0.1.67 (September 11, 2026)

- Text you are typing on the canvas now zooms and pans with the canvas

## 0.1.66 (September 9, 2026)

- Group width and height now match what is actually inside the group
...
- `sw rename <file|dir>` moves a whole folder of .sw.png files onto .sw

## 0.1.60 (September 5, 2026)

- A document Preview had touched no longer gets Gatekeeper's "could not verify it is free of malware" on double-click
...
## 0.1.47 (August 30, 2026)

- New text always has a fill
- Pictures too big for Extend, Remove or Vectorize are shrunk to fit before they go, and the answer comes back at full size
