...
///
/// The same shape serves OpenRouter and Accomplice; only the URLs differ. Pasting an
...
final class OAuthFlow: NSObject {
    ...
    struct Provider {
        ...
        /// Points at wherever Accomplice accounts end up living. accomplice.ai
        ...
        static func accomplice(base: String) -> Provider {
