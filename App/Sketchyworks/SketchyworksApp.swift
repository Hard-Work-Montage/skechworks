...
extension Notification.Name {
    static let showCommandBar = Notification.Name("sketchyworks.showCommandBar")
}

extension SketchyworksApp {
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ n: Notification) {
        ...
        if TestFixture.requested {
            DocumentStore.recoveryDirOverride = FileManager.default.temporaryDirectory
                .appendingPathComponent("SketchyworksUITestRecovery", isDirectory: true)
    ...
    /// Double-clicking a document in Finder, or `open -a Sketchyworks <file>`.
