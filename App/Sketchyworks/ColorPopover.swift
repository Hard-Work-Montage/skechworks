...
struct ColorPopoverButton: View {
    let color: SketchyworksCore.Color
    var supportsOpacity = true
    let onChange: (SketchyworksCore.Color) -> Void
...
private struct ColorPickerPane: View {
    ...
    init(color: SketchyworksCore.Color, supportsOpacity: Bool,
         onChange: @escaping (SketchyworksCore.Color) -> Void) {
    ...
    private var current: SketchyworksCore.Color {
        let ns = NSColor(hue: hue, saturation: sat, brightness: bri, alpha: alpha)
            .usingColorSpace(.sRGB) ?? .black
        return SketchyworksCore.Color(r: ns.redComponent, g: ns.greenComponent,
    ...
    private func commitHex() {
        guard let c = SketchyworksCore.Color(hex: hexTyped, alpha: alpha) else {
    ...
    private static func digits(_ c: SketchyworksCore.Color) -> String {
