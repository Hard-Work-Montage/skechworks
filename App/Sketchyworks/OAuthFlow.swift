...
///
/// The same shape serves OpenRouter and Sketchyworks; only the URLs differ. Pasting an
...
final class OAuthFlow: NSObject {
    ...
    struct Provider {
        ...
        /// Points at wherever Sketchyworks accounts end up living. sketchy.works
        ...
        static func sketchyworks(base: String) -> Provider {
    ...
    nonisolated static let callbackScheme = "sketchyworks"
