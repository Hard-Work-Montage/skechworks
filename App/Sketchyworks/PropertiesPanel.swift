...
struct PropertiesPanel: View {
    ...
    private func borderColor(_ l: Layer) -> SketchyworksCore.Color? {
        l.style.borders.first?.color
    }

    private func applyBorderColor(_ c: SketchyworksCore.Color) {
    ...
    private func solidFill(_ l: Layer) -> SketchyworksCore.Color? {
        guard let f = l.style.fills.first, case .color(let c) = f.paint else { return nil }
        return c
    }

    private func applyFill(_ c: SketchyworksCore.Color) {
