...
struct ContentView: View {
    ...
    @AppStorage("ai.backend") private var chatBackend = ModelConnector.Backend.sketchyworks.rawValue
    ...
    private var chatModel: String {
        ModelConnector.Backend(rawValue: chatBackend) == .openRouter
            ? chatRemoteModel : "your Sketchyworks account"
    }
    ...
    var body: some View {
        ...
        // tab reading "Sketchyworks" tells you nothing.
            ...
            if showCommandBar {
                VSplitView {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        railHeader("Sketchyworks Chat", help: "Using \(chatModel)") {
                            Button {
