...
extension Notification.Name {
    static let showCommandBar = Notification.Name("skechworks.showCommandBar")
}

extension SkechworksApp {
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ n: Notification) {
        ...
        if TestFixture.requested {
            DocumentStore.recoveryDirOverride = FileManager.default.temporaryDirectory
                .appendingPathComponent("SkechworksUITestRecovery", isDirectory: true)
    ...
    /// Double-clicking a document in Finder, or `open -a Skechworks <file>`.
