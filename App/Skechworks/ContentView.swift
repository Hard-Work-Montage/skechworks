...
struct ContentView: View {
    ...
    @AppStorage("ai.backend") private var chatBackend = ModelConnector.Backend.skechworks.rawValue
    ...
    private var chatModel: String {
        ModelConnector.Backend(rawValue: chatBackend) == .openRouter
            ? chatRemoteModel : "your Skechworks account"
    }
    ...
    var body: some View {
        ...
        // tab reading "Skechworks" tells you nothing.
            ...
            if showCommandBar {
                VSplitView {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        railHeader("Skechworks Chat", help: "Using \(chatModel)") {
                            Button {
