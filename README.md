<p align="center">
  <img src="site/logo.png" alt="Skechworks" width="96">
</p>
...
<p align="center">
  <a href="https://skechworks.com">skechworks.com</a>&nbsp; • &nbsp;
  <a href="https://skechworks.com/download">Download for Mac</a>&nbsp; • &nbsp;
  3 MB&nbsp; • &nbsp;macOS 14+&nbsp; • &nbsp;MIT
</p>

<p align="center">
  <a href="https://github.com/adamhowell/skechworks/actions/workflows/ci.yml"><img src="https://github.com/adamhowell/skechworks/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
...
<p align="center">
  <img src="site/hero.png" alt="Skechworks: four artboards of a logo in different colours, with the layer list, inspector and built-in chat." width="840">
</p>

## Why I built Skechworks
...
Skechworks is how I make sure neither eviction happens again. It's a 3 MB native Mac
...
Grab the [signed, notarized build](https://skechworks.com/download), unzip, drop it
in Applications, open. Or build it yourself:

```bash
git clone https://github.com/adamhowell/skechworks.git
cd skechworks
./bin/build
...
Use your own OpenRouter key or Skechworks credits. There's nothing to download
